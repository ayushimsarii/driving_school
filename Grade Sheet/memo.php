...
<div class="container">
		...
		<div class="row" style="width:80%;">
			...
			<?php 
				...
				<h4>Memorandum For Record</h4>
				<div>
					Student name : <?php echo $fetchname?><br>
					Course name : <?php echo $std_course?>
				</div>
				<center>
				<form class="insert-phases" id="memo" method="post" action="insert_memo_data.php">
						<div class="input-field">
								<table class="table table-bordered" id="table-field-memo">
									<tr>
									...
									<button class="btn btn-success" type="submit" name="submit_memo">Save</button>
						</div>
				</form>	
				</center>
		</div>
 ...
 <script type="text/javascript">
		 	$(document).ready(function()
		 	{
			 		var html = '<tr>\
									...
									<td><input maxlength="20" type="text" name="topic[]" class="form-control" placeholder="Topic"></td>\
									<td><textarea style="height:20px;" maxlength="100" type="text" name="comment[]" class="form-control" placeholder="Comment"></textarea></td>\
									<td><button type="button" name="remove_memo" id="remove_memo" class="btn btn-outline-danger"><i class="fas fa-minus-circle"></i></button></td>\
								</tr>'
				    var max = 5;
					var a = 1;
