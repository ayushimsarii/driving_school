...
<header>
    <div class="owl-carousel owl-theme">
        <div class="item">
            <img src="https://web-static.wrike.com/blog/content/uploads/2020/01/Five-Features-of-a-Good-Monthly-Employee-Work-Schedule-Template.jpg?av=718acbc1e2b21264368f12b5cc57c0e2" alt="images not found">
            <div class="cover">
                <div class="container">
                    <div class="header-content">
                        <div class="line"></div>
                        <h2>We Are Coming Soon....!</h2>
                        <h1>TOS/Scheduling</h1>
                        <h4>Wait For Our New Update...!</h4>
                    </div>
                </div>
             </div>
        </div>                    
