              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    ...
                    <input type="text" id="coursename" class="form-control form-control-md" />
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-outline">
                    ...
                    <input type="text" id="coursenumber" class="form-control form-control-md" />
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    ...
                    <select type="text" id="coursemanager" class="form-control form-control-md">
                        <option selected disabled value=""></option>
               ...
               <div class="row">
                <div class="col-md-12 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" class="form-control form-control-md" id="Symbol" />
